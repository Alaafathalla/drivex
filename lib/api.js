...
export const RENTALS = [
  {
    ...
    transmission: 'Automatic', fuel: 'Petrol', seats: 5, category: 'SUV', body: 'SUV',
    available: true, deposit: 1000, minDays: 1, locations: ['Dubai Marina', 'Downtown Dubai', 'Palm Jumeirah'],
    image: 'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?auto=format&fit=crop&w=900&q=90',
    gallery: [
  ...
  },
  {
    ...
    transmission: 'Automatic', fuel: 'Petrol', seats: 5, category: 'Luxury', body: 'Sedan', body: 'Sedan',
    available: true, deposit: 800, minDays: 1, locations: ['Downtown Dubai', 'Dubai Airport', 'Abu Dhabi Corniche'],
    image: 'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&w=900&q=90',
    gallery: ['https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&w=1200&q=90'],
  ...
  },
  {
    ...
    transmission: 'Automatic', fuel: 'Electric', seats: 5, category: 'Electric', body: 'SUV',
    available: true, deposit: 900, minDays: 1, locations: ['Dubai Marina', 'Dubai Airport', 'Sharjah'],
    image: 'https://images.unsplash.com/photo-1560958089-b8a1929cea89?auto=format&fit=crop&w=900&q=90',
    gallery: ['https://images.unsplash.com/photo-1560958089-b8a1929cea89?auto=format&fit=crop&w=1200&q=90'],
  ...
  },
  {
    ...
    transmission: 'Automatic', fuel: 'Petrol', seats: 5, category: 'Sports', body: 'SUV',
    available: false, deposit: 1500, minDays: 2, locations: ['Palm Jumeirah', 'Downtown Dubai'],
    image: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=900&q=90',
    gallery: ['https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=90'],
  ...
  },
  {
    ...
    transmission: 'Automatic', fuel: 'Diesel', seats: 7, category: 'SUV', body: 'SUV',
    available: true, deposit: 1100, minDays: 1, locations: ['Abu Dhabi Corniche', 'Dubai Marina', 'Sharjah'],
...
export const api = {
  ...
  async getRentals(filters = {}) {
    ...
    if (filters.category && filters.category !== 'All') {
      ...
      if (category === 'sedan') result = result.filter((r) => r.body?.toLowerCase() === 'sedan')
      else if (category === '7 seater' || category === '7-seater') result = result.filter((r) => r.seats >= 7)
      else result = result.filter((r) => r.category.toLowerCase() === category)
    }
    if (filters.location) {
      result = result.filter((r) => r.locations?.some((location) => location.toLowerCase() === filters.location.toLowerCase()))
    }
